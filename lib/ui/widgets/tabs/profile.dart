                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image: isDarkMode?AssetImage(AppImages.ProfilBannerDark):AssetImage(AppImages.ProfilBannerLight),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                  child: Column(
                              ...
                              Container(
                                ...
                                child: ListTile(
                                  title: Text('Statut\n',
                                      style: TextStyle(
                                        fontSize: 20.0,
                                        color: isDarkMode?Color(0xffF7F7F7):AppColors.PrimaryColor,
                                      )),
                                  subtitle: Text(
                                    'qkjsdhqksjdhqisdu',
                                    style: TextStyle(
                                ...
                                children: [
                                  Container(
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                              width: 3.0, color: isDarkMode?Color(0xffF7F7F7):AppColors.PrimaryColor,)),
